...
class KonstantinovSRunFuncTestsThreads : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(std::string(PPC_ID_konstantinov_s_graham), "pic.ppm");
...
TEST_P(KonstantinovSRunFuncTestsThreads, MatmulFromPic) {
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, KonstantinovSRunFuncTestsThreads, kGtestValues, kPerfTestName);
