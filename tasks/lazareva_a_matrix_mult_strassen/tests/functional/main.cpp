...
class LazarevaARunFuncTestsThreads
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<LazarevaATestTaskSEQ, InType>(
        kTestParam, PPC_SETTINGS_lazareva_a_matrix_mult_strassen);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName =
    LazarevaARunFuncTestsThreads::PrintFuncTestName<LazarevaARunFuncTestsThreads>;

INSTANTIATE_TEST_SUITE_P(SeqMatrixTests, LazarevaARunFuncTestsThreads,
