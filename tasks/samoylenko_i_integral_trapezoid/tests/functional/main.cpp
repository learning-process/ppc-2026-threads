...
class SamoylenkoITrapezoidIntegrationFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SamoylenkoITrapezoidIntegrationFuncTests, IntegrationTest) {
