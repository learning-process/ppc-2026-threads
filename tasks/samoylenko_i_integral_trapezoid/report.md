...
процессоров комбинацией процессов и потоков. Во-вторых, в алгоритме ALL, в отличие от других реализаций,
оптимизировано вычисление координат сетки для точек диапазона.
Поэтому на графиках эффективности она местами превышает 100%.
