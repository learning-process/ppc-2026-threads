...
LinearImageFilteringVerticalTBB::LinearImageFilteringVerticalTBB(
    const InType& in) {
...
bool LinearImageFilteringVerticalTBB::RunImpl() {
  ...
  tbb::parallel_for(
      tbb::blocked_range<int>(0, w, block_width),
...
bool LinearImageFilteringVerticalTBB::PostProcessingImpl() { return true; }
