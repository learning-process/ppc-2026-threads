...
class ZeninARadixSortDoubleBatcherMergeFuncTestsThreads : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<ZeninARadixSortDoubleBatcherMerge_SEQSEQ, InType>(kTestParam, PPC_SETTINGS_zenin_a_radix_sort_double_batcher_merge_seq));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = ZeninARadixSortDoubleBatcherMergeFuncTestsThreads::PrintFuncTestName<ZeninARadixSortDoubleBatcherMergeFuncTestsThreads>;

INSTANTIATE_TEST_SUITE_P(PicMatrixTests, ZeninARadixSortDoubleBatcherMergeFuncTestsThreads, kGtestValues, kPerfTestName);
