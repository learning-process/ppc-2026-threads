...
class SafaryanARunFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SafaryanARunFuncTests, SparseMatrixMultiplication) {
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<SafaryanATaskALL, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs),
    ppc::util::AddFuncTask<SafaryanATaskOMP, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs),
    ppc::util::AddFuncTask<SafaryanATaskSEQ, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs),
    ppc::util::AddFuncTask<SafaryanATaskSTL, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs),
    ppc::util::AddFuncTask<SafaryanATaskTBB, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);
const auto kPerfTestName = SafaryanARunFuncTests::PrintFuncTestName<SafaryanARunFuncTests>;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultFixedTests, SafaryanARunFuncTests, kGtestValues, kPerfTestName);
