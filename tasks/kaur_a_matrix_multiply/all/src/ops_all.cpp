...
KaurAMatrixMultiplyALL::KaurAMatrixMultiplyALL(const InType &in) {
...
bool KaurAMatrixMultiplyALL::ValidationImpl() {
  int rank = 0;
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);
  if (rank != 0) {
    return true;
...
bool KaurAMatrixMultiplyALL::PreProcessingImpl() {
  return true;
}

bool KaurAMatrixMultiplyALL::RunImpl() {
  int rank = 0;
  int world_size = 1;
  MPI_Comm_rank(MPI_COMM_WORLD, &rank);
...
bool KaurAMatrixMultiplyALL::PostProcessingImpl() {
  return true;
}
