...
class KaurAMatrixMultiplyPerfTest : public ppc::util::BaseRunPerfTests<InType, OutType> {
...
TEST_P(KaurAMatrixMultiplyPerfTest, RunPerfModes) {
...
const auto kPerfTestName = KaurAMatrixMultiplyPerfTest::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(RunModeTests, KaurAMatrixMultiplyPerfTest, kGtestValues, kPerfTestName);
