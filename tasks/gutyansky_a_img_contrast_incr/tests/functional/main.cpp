...
const std::array<TestType, 10> kTestParam = {"test_1", "test_2", "test_3", "test_4", "test_5", "test_6", "test_7", "test_8", "test_9", "test_10"};

const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<GutyanskyAImgContrastIncrSEQ, InType>(kTestParam, PPC_SETTINGS_gutyansky_a_img_contrast_incr));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = GutyanskyARunFuncTestsImgContrastIncr::PrintFuncTestName<GutyanskyARunFuncTestsImgContrastIncr>;
