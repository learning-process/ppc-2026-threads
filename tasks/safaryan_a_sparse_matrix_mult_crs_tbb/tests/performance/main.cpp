...
class SafaryanARunPerfTestTBB : public ppc::util::BaseRunPerfTests<InType, OutType> {
...
TEST_P(SafaryanARunPerfTestTBB, RunPerfModes) {
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SafaryanATaskTBB>(PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_tbb);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);

const auto kPerfTestName = SafaryanARunPerfTestTBB::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultPerfTests, SafaryanARunPerfTestTBB, kGtestValues, kPerfTestName);
