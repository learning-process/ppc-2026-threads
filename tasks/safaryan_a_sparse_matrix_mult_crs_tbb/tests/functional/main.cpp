...
#include "safaryan_a_sparse_matrix_mult_crs_tbb/common/include/common.hpp"
#include "safaryan_a_sparse_matrix_mult_crs_tbb/tbb/include/ops_tbb.hpp"
#include "util/include/func_test_util.hpp"
#include "util/include/util.hpp"

namespace safaryan_a_sparse_matrix_mult_crs_tbb {
...
class SafaryanARunFuncTestsTBB : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SafaryanARunFuncTestsTBB, SparseMatrixMultiplication) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<SafaryanATaskTBB, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_tbb);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = SafaryanARunFuncTestsTBB::PrintFuncTestName<SafaryanARunFuncTestsTBB>;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultFixedTests, SafaryanARunFuncTestsTBB, kGtestValues, kPerfTestName);
