...
#include "safaryan_a_sparse_matrix_mult_crs_omp/common/include/common.hpp"
#include "safaryan_a_sparse_matrix_mult_crs_omp/omp/include/ops_omp.hpp"
#include "util/include/func_test_util.hpp"
#include "util/include/util.hpp"

namespace safaryan_a_sparse_matrix_mult_crs_omp {
...
class SafaryanARunFuncTestsOMP : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SafaryanARunFuncTestsOMP, SparseMatrixMultiplication) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<SafaryanATaskOMP, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_omp);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = SafaryanARunFuncTestsOMP::PrintFuncTestName<SafaryanARunFuncTestsOMP>;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultFixedTests, SafaryanARunFuncTestsOMP, kGtestValues, kPerfTestName);
