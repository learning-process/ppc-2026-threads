...
class SafaryanARunPerfTestOMP : public ppc::util::BaseRunPerfTests<InType, OutType> {
...
TEST_P(SafaryanARunPerfTestOMP, RunPerfModes) {
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SafaryanATaskOMP>(PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_omp);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);

const auto kPerfTestName = SafaryanARunPerfTestOMP::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultPerfTests, SafaryanARunPerfTestOMP, kGtestValues, kPerfTestName);
