...
KaurADijkstraAlgALL::KaurADijkstraAlgALL(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = 0;
}

bool KaurADijkstraAlgALL::ValidationImpl() {
  return GetInput() > 0;
}

bool KaurADijkstraAlgALL::PreProcessingImpl() {
...
bool KaurADijkstraAlgALL::RunImpl() {
  const InType n = GetInput();
  const InType inf = std::numeric_limits<InType>::max();
...
bool KaurADijkstraAlgALL::PostProcessingImpl() {
