...
bool PikhotskiyRVerticalGaussFilterSTL::ValidationImpl() {
...
bool PikhotskiyRVerticalGaussFilterSTL::PreProcessingImpl() {
  const auto &in = GetInput();
  width_ = in.width;
  height_ = in.height;
...
bool PikhotskiyRVerticalGaussFilterSTL::RunImpl() {
...
bool PikhotskiyRVerticalGaussFilterSTL::PostProcessingImpl() {
...
void PikhotskiyRVerticalGaussFilterSTL::RunVerticalPassForStripe(int x_begin, int x_end) {
...
void PikhotskiyRVerticalGaussFilterSTL::RunHorizontalPassForStripe(int x_begin, int x_end) {
  for (int row = 0; row < height_; ++row) {
    for (int col = x_begin; col < x_end; ++col) {
