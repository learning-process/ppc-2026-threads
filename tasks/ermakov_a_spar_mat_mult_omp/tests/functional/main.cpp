...
class ErmakovARunFuncTestSparMatMultOMP : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(ErmakovARunFuncTestSparMatMultOMP, MatmulCRSOMP) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<ErmakovASparMatMultOMP, InType>(kTestParam, PPC_SETTINGS_ermakov_a_spar_mat_mult_omp);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = ErmakovARunFuncTestSparMatMultOMP::PrintFuncTestName<ErmakovARunFuncTestSparMatMultOMP>;

INSTANTIATE_TEST_SUITE_P(SparseCRSMatMulOMPTests, ErmakovARunFuncTestSparMatMultOMP, kGtestValues, kPerfTestName);
