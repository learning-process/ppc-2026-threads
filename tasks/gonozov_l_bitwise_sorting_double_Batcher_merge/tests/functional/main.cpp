...
const std::array<TestType, 4> kTestParam = {
    std::make_tuple(std::vector<double>{3.0, 7.0, 1.0, 5.0, 2.0, 11.0}, std::vector<double>{1.0, 2.0, 3.0, 5.0, 7.0, 11.0}, "sorting_positive_simple_integers"), 
    std::make_tuple(std::vector<double>{3.5, 7.6, 7.1, 5.8, 5.2, 1.1}, std::vector<double>{1.1, 3.5, 5.2, 5.8, 7.1, 7.6}, "sorting_positive_double"), 
    std::make_tuple(std::vector<double>{-3.0, 7.0, -1.0, 5.0, -2.0, 11.0}, std::vector<double>{-3.0, -2.0, -1.0, 5.0, 7.0, 11.0}, "sorting_pos_and_neg_integers"), 
    std::make_tuple(std::vector<double>{3.5, -7.6, 7.1, -5.8, 5.2, -1.1}, std::vector<double>{-7.6, -5.8, -1.1, 3.5, 5.2, 7.1}, "sorting_pos_and_neg_double"), 
  };
