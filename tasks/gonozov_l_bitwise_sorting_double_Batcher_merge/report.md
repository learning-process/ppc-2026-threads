...
В рамках курса по параллельному программированию была реализована задача поразрядной сортировки вещественных чисел типа `double` с использованием четно-нечетного слияния Бэтчера. Целью работы является сравнение пяти различных подходов к параллелизации:
