...
INSTANTIATE_TEST_SUITE_P(SEQRunModeTests, ArtyushkinaMarkirovkaPerfTests, kGtestValues, kPerfTestName);
...
const auto kPerfTestName = ArtyushkinaMarkirovkaTBBPerfTests::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(TBBRunModeTests, ArtyushkinaMarkirovkaTBBPerfTests, kGtestValues, kPerfTestName);
