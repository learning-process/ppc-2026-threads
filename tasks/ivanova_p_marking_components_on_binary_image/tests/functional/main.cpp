 ...
 protected:
  ...
  bool CheckTestOutputData(OutType &output_data) final {
    ...
    switch (current_test_case_) {
      case 1: expected_components = 1; break;
      case 2: expected_components = 2; break;
      case 3: expected_components = 3; break;
      case 4: expected_components = 1; break;
      case 5: expected_components = 0; break;  // Все фон
      case 6: expected_components = 1; break;  // Одиночный пиксель
      case 7: expected_components = 4; break;  // Диагональные соседи - 4 компоненты
      case 8: expected_components = 9; break;  // 9 маленьких компонент
      case 9: expected_components = 1; break;  // Горизонтальная линия
      case 10: expected_components = 1; break; // Вертикальная линия
      case 11: expected_components = 1; break; // image.txt - 1 компонента
      case 12: expected_components = 2; break; // image2.txt - 2 компоненты
      case 13: expected_components = 2; break; // image3.txt - 2 компоненты
      case 14: expected_components = 9; break; // image4.txt - 9 компонент
      default: expected_components = num_components;
    }
...
const std::array<TestType, 14> kTestParam = {
    std::make_tuple(1, "single_component"),
    std::make_tuple(2, "two_components"),
    std::make_tuple(3, "three_components"),
    std::make_tuple(4, "connected_components"),
    std::make_tuple(5, "all_background"),
    std::make_tuple(6, "single_pixel"),
    std::make_tuple(7, "diagonal_neighbors"),
    std::make_tuple(8, "many_small_components"),
    std::make_tuple(9, "horizontal_line"),
    std::make_tuple(10, "vertical_line"),
    std::make_tuple(11, "file_image"),
    std::make_tuple(12, "file_image2"),
    std::make_tuple(13, "file_image3"),
    std::make_tuple(14, "file_image4")
};

const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<IvanovaPMarkingComponentsOnBinaryImageSEQ, InType>(
