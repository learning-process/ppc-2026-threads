...
#include "makoveeva_matmul_double/common/include/common.hpp"
#include "makoveeva_matmul_double/seq/include/ops_seq.hpp"
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<MatmulDoubleSeqTask, InType>(kTestParams, PPC_SETTINGS_makoveeva_matmul_double);
