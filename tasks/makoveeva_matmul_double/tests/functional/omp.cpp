...
#include "makoveeva_matmul_double/omp/include/ops_omp.hpp"
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<MatmulDoubleOMPTask, InType>(kTestParams, PPC_SETTINGS_makoveeva_matmul_double);
