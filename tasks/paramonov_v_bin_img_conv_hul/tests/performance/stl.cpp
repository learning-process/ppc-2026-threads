...
class ConvexHullSTLPerformanceTest : public ppc::util::BaseRunPerfTests<InputType, OutputType> {
...
TEST_P(ConvexHullSTLPerformanceTest, RunPerformanceTest) {
...
const auto kPerformanceTasks =
    ppc::util::MakeAllPerfTasks<InputType, ConvexHullSTL>(PPC_SETTINGS_paramonov_v_bin_img_conv_hul);

const auto kTestValues = ppc::util::TupleToGTestValues(kPerformanceTasks);

INSTANTIATE_TEST_SUITE_P(ParamonovPerfSTLTests, ConvexHullSTLPerformanceTest, kTestValues,
                         ConvexHullSTLPerformanceTest::CustomPerfTestName);
