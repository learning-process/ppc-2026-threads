...
#include "paramonov_v_bin_img_conv_hul/all/include/common.hpp"
#include "paramonov_v_bin_img_conv_hul/all/include/ops_all.hpp"
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<ConvexHullAll, InputType>(kTestCases, PPC_SETTINGS_paramonov_v_bin_img_conv_hul));
