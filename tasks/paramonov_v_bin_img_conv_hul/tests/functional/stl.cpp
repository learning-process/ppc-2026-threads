...
#include "paramonov_v_bin_img_conv_hul/stl/include/common.hpp"
#include "paramonov_v_bin_img_conv_hul/stl/include/ops_stl.hpp"
...
class ConvexHullSTLFuncTest : public ppc::util::BaseRunFuncTests<InputType, OutputType, TestCase> {
 public:
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<ConvexHullSTL, InputType>(kTestCases, PPC_SETTINGS_paramonov_v_bin_img_conv_hul));

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kFuncTestName = ConvexHullSTLFuncTest::PrintFuncTestName<ConvexHullSTLFuncTest>;

INSTANTIATE_TEST_SUITE_P(ParamonovHullSTLTests, ConvexHullSTLFuncTest, kGtestValues, kFuncTestName);

TEST_P(ConvexHullSTLFuncTest, RunFunctionalTests) {
