...
#include "paramonov_v_bin_img_conv_hul/tbb/include/common.hpp"
#include "paramonov_v_bin_img_conv_hul/tbb/include/ops_tbb.hpp"
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<ConvexHullTBB, InputType>(kTestCases, PPC_SETTINGS_paramonov_v_bin_img_conv_hul));
