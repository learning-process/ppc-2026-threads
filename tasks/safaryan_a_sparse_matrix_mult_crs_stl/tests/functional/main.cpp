...
#include "safaryan_a_sparse_matrix_mult_crs_stl/common/include/common.hpp"
#include "safaryan_a_sparse_matrix_mult_crs_stl/stl/include/ops_stl.hpp"
#include "util/include/func_test_util.hpp"
#include "util/include/util.hpp"

namespace safaryan_a_sparse_matrix_mult_crs_stl {
...
class SafaryanARunFuncTestsSTL : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SafaryanARunFuncTestsSTL, SparseMatrixMultiplication) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<SafaryanATaskSTL, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_stl);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = SafaryanARunFuncTestsSTL::PrintFuncTestName<SafaryanARunFuncTestsSTL>;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultFixedTests, SafaryanARunFuncTestsSTL, kGtestValues, kPerfTestName);
