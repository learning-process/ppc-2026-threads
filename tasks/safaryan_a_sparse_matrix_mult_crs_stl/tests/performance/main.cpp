...
class SafaryanARunPerfTestSTL : public ppc::util::BaseRunPerfTests<InType, OutType> {
...
TEST_P(SafaryanARunPerfTestSTL, RunPerfModes) {
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SafaryanATaskSTL>(PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_stl);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);

const auto kPerfTestName = SafaryanARunPerfTestSTL::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultPerfTests, SafaryanARunPerfTestSTL, kGtestValues, kPerfTestName);
