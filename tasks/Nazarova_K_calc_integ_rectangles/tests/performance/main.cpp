...
#include "Nazarova_K_calc_integ_rectangles/omp/include/ops_omp.hpp"
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, NazarovaKCalcIntegRectanglesOMP>(PPC_SETTINGS_Nazarova_K_calc_integ_rectangles);
