...
- **TBB**: Показывает нестабильное ускорение. При 2 потоках ускорение ниже 1x, при 4 — 1.21x. Сказываются накладные расходы runtime.
- **STL**: Показывает лучшее ускорение среди всех технологий (1.69x при 4 потоках). Эффективное ручное управление распределением работы даёт выигрыш.
