...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, KurpiskovACRSMatMulSEQ, KurpiakovACRSMatMulOMP, KurpiakovACRSMatMulTBB, KurpiakovACRSMatMulSTL, KurpiakovACRSMatMulALL>(PPC_SETTINGS_kurpiakov_a_sp_comp_mat_mul);
