...
## 9. Выводы
OMP‑результат ниже SEQ на выбранном размере; это согласуется с высокими накладными расходами при построчной динамической балансировке без подтверждающего профилирования.