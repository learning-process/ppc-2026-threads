...
const Matrix kInput3x3_16 = MakeMatrix(3, 3, std::vector<uint8_t>(9, 16));
const Matrix kExpected3x3_16 = MakeMatrix(3, 3, std::vector<uint8_t>(9, 16));

const Matrix kInput3x3_42 = MakeMatrix(3, 3, std::vector<uint8_t>(9, 42));
const Matrix kExpected3x3_42 = MakeMatrix(3, 3, std::vector<uint8_t>(9, 42));

const Matrix kInput4x4_100 = MakeMatrix(4, 4, std::vector<uint8_t>(16, 100));
