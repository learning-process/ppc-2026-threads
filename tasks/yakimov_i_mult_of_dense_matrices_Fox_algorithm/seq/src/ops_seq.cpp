...
void MultiplyBlock(const DenseMatrix& a, const DenseMatrix& b, 
                   DenseMatrix& result, 
...
void FoxAlgorithmImpl(const DenseMatrix& a, const DenseMatrix& b, 
                      DenseMatrix& result, int block_size) {
...
YakimovIMultOfDenseMatricesFoxAlgorithmSEQ::YakimovIMultOfDenseMatricesFoxAlgorithmSEQ(const InType& in) {
    ...
    this->matrix_a_filename_ = ppc::util::GetAbsoluteTaskPath(
        task_name, "A_" + std::to_string(this->GetInput()) + ".txt");
    
    this->matrix_b_filename_ = ppc::util::GetAbsoluteTaskPath(
        task_name, "B_" + std::to_string(this->GetInput()) + ".txt");
}
...
bool YakimovIMultOfDenseMatricesFoxAlgorithmSEQ::RunImpl() {
    FoxAlgorithmImpl(this->matrix_a_, this->matrix_b_, 
                     this->result_matrix_, this->block_size_);
