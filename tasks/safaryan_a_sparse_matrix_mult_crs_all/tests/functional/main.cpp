...
class SafaryanARunFuncTestsALL : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
TEST_P(SafaryanARunFuncTestsALL, SparseMatrixMultiplication) {
...
const auto kTestTasksList =
    ppc::util::AddFuncTask<SafaryanATaskALL, InType>(kTestParam, PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_all);

const auto kGtestValues = ppc::util::ExpandToValues(kTestTasksList);

const auto kPerfTestName = SafaryanARunFuncTestsALL::PrintFuncTestName<SafaryanARunFuncTestsALL>;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultFixedTests, SafaryanARunFuncTestsALL, kGtestValues, kPerfTestName);
