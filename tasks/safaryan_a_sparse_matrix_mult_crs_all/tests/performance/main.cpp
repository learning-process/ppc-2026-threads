...
class SafaryanARunPerfTestALL : public ppc::util::BaseRunPerfTests<InType, OutType> {
...
TEST_P(SafaryanARunPerfTestALL, RunPerfModes) {
...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SafaryanATaskALL>(PPC_SETTINGS_safaryan_a_sparse_matrix_mult_crs_all);

const auto kGtestValues = ppc::util::TupleToGTestValues(kAllPerfTasks);

const auto kPerfTestName = SafaryanARunPerfTestALL::CustomPerfTestName;

INSTANTIATE_TEST_SUITE_P(SparseMatrixMultPerfTests, SafaryanARunPerfTestALL, kGtestValues, kPerfTestName);
