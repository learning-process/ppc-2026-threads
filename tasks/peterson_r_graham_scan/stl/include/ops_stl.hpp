...
#include "peterson_r_graham_scan/stl/include/common.hpp"
...
class PetersonGrahamScannerSTL : public ppc::task::Task<InputValue, OutputValue> {
 public:
  static constexpr ppc::task::TypeOfTask GetStaticTypeOfTask() {
    return ppc::task::TypeOfTask::kSTL;
  }

  explicit PetersonGrahamScannerSTL(const InputValue &in);
