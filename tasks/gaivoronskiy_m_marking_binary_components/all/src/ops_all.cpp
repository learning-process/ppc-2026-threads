...
GaivoronskiyMMarkingBinaryComponentsALL::GaivoronskiyMMarkingBinaryComponentsALL(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
  GetOutput() = {};
}

bool GaivoronskiyMMarkingBinaryComponentsALL::ValidationImpl() {
...
bool GaivoronskiyMMarkingBinaryComponentsALL::PreProcessingImpl() {
  const auto &input = GetInput();
  const int rows = input[0];
  const int cols = input[1];
...
bool GaivoronskiyMMarkingBinaryComponentsALL::RunImpl() {
  const auto &input = GetInput();
...
bool GaivoronskiyMMarkingBinaryComponentsALL::PostProcessingImpl() {
  return true;
}
