...
### Замечание про режим `pipeline`

В отчёте SEQ дополнительно указано время `pipeline` ($p=1$: $0.00001874$ с; $p=8$: $0.00003100$ с). В сводной таблице
выше для сравнения технологий использован единый режим **`task_run`**, как в методике курса.
