...
const auto kAllPerfTasks = ppc::util::MakeAllPerfTasks<InType, ZeninARadixSortDoubleBatcherMergeOMP>(
    PPC_SETTINGS_zenin_a_radix_sort_double_batcher_merge_omp);
