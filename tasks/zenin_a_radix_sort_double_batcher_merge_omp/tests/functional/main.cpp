...
const auto kTestTasksList = std::tuple_cat(ppc::util::AddFuncTask<ZeninARadixSortDoubleBatcherMergeOMP, InType>(
    kTestParam, PPC_SETTINGS_zenin_a_radix_sort_double_batcher_merge_omp));
