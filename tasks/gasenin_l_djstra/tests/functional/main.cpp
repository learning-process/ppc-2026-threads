...
const auto kTestTasksList =
    std::tuple_cat(/*ppc::util::AddFuncTask<GaseninLDjstraALL, InType>(kTestParam, PPC_SETTINGS_gasenin_l_djstra),
                   ppc::util::AddFuncTask<GaseninLDjstraOMP, InType>(kTestParam, PPC_SETTINGS_gasenin_l_djstra),*/
                   ppc::util::AddFuncTask<GaseninLDjstraSEQ, InType>(kTestParam, PPC_SETTINGS_gasenin_l_djstra)/*,
                   ppc::util::AddFuncTask<GaseninLDjstraSTL, InType>(kTestParam, PPC_SETTINGS_gasenin_l_djstra),
                   ppc::util::AddFuncTask<GaseninLDjstraTBB, InType>(kTestParam, PPC_SETTINGS_gasenin_l_djstra)*/);
