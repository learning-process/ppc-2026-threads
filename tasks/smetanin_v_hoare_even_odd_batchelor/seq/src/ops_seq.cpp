...
SmetaninVHoarSortSEQ::SmetaninVHoarSortSEQ(const InType &in) {
  SetTypeOfTask(GetStaticTypeOfTask());
  GetInput() = in;
}

bool SmetaninVHoarSortSEQ::ValidationImpl() {
  return true;
}

bool SmetaninVHoarSortSEQ::PreProcessingImpl() {
  GetOutput() = GetInput();
  return true;
}

bool SmetaninVHoarSortSEQ::RunImpl() {
  auto &data = GetOutput();
...
bool SmetaninVHoarSortSEQ::PostProcessingImpl() {
  return true;
}
