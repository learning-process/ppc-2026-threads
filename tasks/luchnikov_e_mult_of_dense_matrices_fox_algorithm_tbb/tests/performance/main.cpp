...
class LuchnikovEMultOfDenseMatrixFoxAlgoritmPerfTestTBB : public ppc::util::BaseRunPerfTests<InType, OutType> {
 protected:
...
const auto kPerfTaskList =
    std::tuple_cat(ppc::util::MakeAllPerfTasks<InType, LuchnikovEMultOfDenseMatrixFoxAlgoritmTBB>(
...
INSTANTIATE_TEST_SUITE_P(TBBFoxAlgorithmBenchmark, LuchnikovEMultOfDenseMatrixFoxAlgoritmPerfTestTBB, kGtestParams,
                         kTestPrinter);
