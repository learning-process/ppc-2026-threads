...
class RemizovKDenseMatrixMultiplicationCannonAlgorithm : public BaseTask {
 ...
 private:
  ...
  void MultiplyBlock(const std::vector<std::vector<double>> &a, const std::vector<std::vector<double>> &b,
                     std::vector<std::vector<double>> &c, int block_size);

  void ShiftBlocksLeft(std::vector<std::vector<std::vector<std::vector<double>>>> &matrix_blocks, int block_count);

  void ShiftBlocksUp(std::vector<std::vector<std::vector<std::vector<double>>>> &matrix_blocks, int block_count);

  void RunCannonCycle(std::vector<std::vector<std::vector<std::vector<double>>>> &a_blocks,
  ...
  void AssembleOutput(std::vector<std::vector<std::vector<std::vector<double>>>> &c_blocks,
                      std::vector<std::vector<double>> &output, int block_size, int block_count);

  void InitializeBlocks(const std::vector<std::vector<double>> &matrix_a,
