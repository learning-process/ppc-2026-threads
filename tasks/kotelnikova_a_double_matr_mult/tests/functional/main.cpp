...
SparseMatrixCCS CreateMatrix(int rows, int cols, 
 ...
 protected:
  void SetUp() override {
    ...
    switch(test_case) {
      case 1:
        {
          SparseMatrixCCS A = CreateMatrix(3, 3,
                                           {1.5, 4.2, 3.7, 2.8, 5.1},
                                           {0, 2, 1, 0, 2},
                                           {0, 2, 3, 5});
          
          SparseMatrixCCS B = CreateMatrix(3, 3,
                                           {1.2, 2.3, 3.4},
                                           {0, 1, 2},
                                           {0, 1, 2, 3});
          
          expected_output_ = CreateMatrix(3, 3,
                                          {1.8, 5.04, 8.51, 9.52, 17.34},
                                          {0, 2, 1, 0, 2},
                                          {0, 2, 3, 5});
      ...
      case 2:
        {
          SparseMatrixCCS A = CreateMatrix(2, 3,
                                           {1.2, 2.5, 3.7},
                                           {0, 0, 1},
                                           {0, 1, 2, 3});
          
          SparseMatrixCCS B = CreateMatrix(3, 2,
                                           {1.1, 3.3, 2.2},
                                           {0, 2, 1},
                                           {0, 2, 3});
          
          expected_output_ = CreateMatrix(2, 2,
                                          {1.32, 12.21, 5.5},
                                          {0, 1, 0},
                                          {0, 2, 3});
      ...
      case 3:
        {
          SparseMatrixCCS A = CreateMatrix(2, 2,
                                           {2.5},
                                           {0},
                                           {0, 1, 1});
          
          SparseMatrixCCS B = CreateMatrix(2, 2,
                                           {3.7},
                                           {1},
                                           {0, 1, 1});
      ...
      case 4:
        {
          SparseMatrixCCS A = CreateMatrix(3, 3,
                                           {1.1, 4.2, 7.3, 2.4, 5.5, 8.6, 3.7, 6.8, 9.9},
                                           {0, 1, 2, 0, 1, 2, 0, 1, 2},
                                           {0, 3, 6, 9});
      ...
      case 5:
        {
          SparseMatrixCCS A = CreateMatrix(4, 4,
                                           {1.5, 2.5, 3.5, 4.5},
                                           {0, 1, 2, 3},
                                           {0, 1, 2, 3, 4});
          
          SparseMatrixCCS B = CreateMatrix(4, 4,
                                           {5.5, 6.5, 7.5, 8.5},
                                           {0, 1, 2, 3},
                                           {0, 1, 2, 3, 4});
          
          expected_output_ = CreateMatrix(4, 4,
                                          {8.25, 16.25, 26.25, 38.25},
                                          {0, 1, 2, 3},
                                          {0, 1, 2, 3, 4});
  ...
  bool CheckTestOutputData(OutType &output_data) final {
    if (output_data.rows != expected_output_.rows || 
        output_data.cols != expected_output_.cols) {
      return false;
    }
...
const std::array<TestType, 5> kTestParam = {
    std::make_tuple(1, 0, 0, "simple_3x3"),
    std::make_tuple(2, 0, 0, "rectangular_2x3_3x2"),
    std::make_tuple(3, 0, 0, "zero_result"),
    std::make_tuple(4, 0, 0, "identity_matrix"),
