...
- backend: all; ranks: 1; threads_per_rank: 12; total_workers: 12; time: 0.0159865600 s; speedup: 0.191; efficiency: 0.016; notes: `mpiexec -n 1`, local STL auto-threads, `TaskRun`.
- backend: all; ranks: 2; threads_per_rank: 12; total_workers: 24; time: 0.0155627800 s; speedup: 0.196; efficiency: 0.008; notes: `mpiexec -n 2`, local STL auto-threads, `TaskRun`.
- backend: all; ranks: 4; threads_per_rank: 12; total_workers: 48; time: 0.0125462200 s; speedup: 0.243; efficiency: 0.005; notes: `mpiexec -n 4`, local STL auto-threads, `TaskRun`.
- backend: all; ranks: 1; threads_per_rank: 12; total_workers: 12; time: 0.0173728400 s; speedup: 0.479; efficiency: 0.040; notes: `mpiexec -n 1`, local STL auto-threads, `pipeline`.
- backend: all; ranks: 4; threads_per_rank: 12; total_workers: 48; time: 0.0142562000 s; speedup: 0.584; efficiency: 0.012; notes: `mpiexec -n 4`, local STL auto-threads, `pipeline`.
